...
void printFeat(Feat output)
{
	...
	std::cout << "General Prerequisites: (";
	for(i=0; i < output.genPrereq.size(); i++){std::cout << output.genPrereq[i] << ", ";}
	std::cout << ')' << std::endl;

	std::cout << "Feat Prerequisites: (";
	for(i=0; i < output.featPrereq.size(); i++){std::cout << output.featPrereq[i] << ", ";}
	std::cout << ')' << std::endl;

	std::cout << "Feat Benefits: " << output.benefits << std::endl;

	std::cout << "Feat Specials: (";
	for(i=0; i < output.special.size(); i++){std::cout << output.special[i] << ", ";}
	std::cout << ')' << std::endl;

	std::cout << "Feat Book: (";
	for(i=0; i < output.sources.size(); i++){std::cout << output.sources[i] << ", ";}
	std::cout << ')' << std::endl;
}
